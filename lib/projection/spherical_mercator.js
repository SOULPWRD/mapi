/*property
    PI, arc_length, atan, exp, extent, freeze, from_pixels, lat, latlng, lng,
    log, max, max_latitude, meters, min, perimeter, pow, radius, sin, tile_size,
    to_latlng, to_meters, to_pixels, x, y
*/
